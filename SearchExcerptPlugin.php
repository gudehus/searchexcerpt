...
class SearchExcerptPlugin extends BasePlugin
{
    /**
    ...
    {
        return Craft::t('Display only the part of a text which contains a given searchterm');
    }
    ...
    {
        return 'https://github.com/gudehus/searchexcerpt/blob/master/README.md';
    }
    ...
    {
        return 'https://raw.githubusercontent.com/gudehus/searchexcerpt/master/releases.json';
    }
